...
const app = createApp(store, { sendEmail, exposeDevLink: !process.env.RESEND_API_KEY, vapidPublicKey: process.env.VAPID_PUBLIC_KEY ?? null, statsKey: process.env.STATS_KEY ?? null });
