...
- Count **fractional/indirect volume** partially: a hard row trains the lats fully but the biceps partially. A common heuristic is to count secondary involvement as ~0.5 of a set. **[Grade D]**
