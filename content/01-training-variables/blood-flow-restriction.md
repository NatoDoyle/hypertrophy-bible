...
> **TL;DR** — BFR (a.k.a. "occlusion" training) uses a cuff or wrap to **partially restrict blood flow** to a limb while you train with **light loads (~20–40% 1RM) to near failure**. Remarkably, this produces **muscle growth comparable to heavy training** — which makes it genuinely useful when you **can't load heavy** (injury, rehab, cranky joints) or want a **low-joint-stress way to add volume**. Heavy training remains at least as good for size and clearly better for **strength**, so BFR is a **specialty tool**, not a replacement. Learn proper cuff technique before using it.

**Quick recommendations**
- Use BFR mainly when **heavy loading isn't an option** (rehab, injury, joint pain) or as low-stress extra volume. **[Grade B]**
- Train at **~20–40% 1RM to near failure**, typically high reps (e.g. 15–30) for several sets. **[Grade C]**
- Apply cuffs at a **moderate, tolerable pressure** (not fully occluding) on the limb; learn correct setup first. **[Grade C]**
- Don't expect it to **beat heavy training** for size, and expect **less strength** than heavy work. **[Grade B]**
...
- **Protocols vary** (cuff width, pressure, rep schemes) and optimal settings aren't fully standardized; the "similar hypertrophy" finding held across several pressure/cuff variations.
- **Safety matters** — improper cuff use is uncomfortable and, in people with vascular or clotting conditions, potentially risky; those individuals should get medical clearance. This Bible is not medical advice.
- **Discomfort is high** — the metabolic "burn" of BFR sets is intense; adherence can suffer.

## Backing Data
None (a training method applied within program design).

## References
[^lixandrao-2018-bfr-meta]: Lixandrão ME, et al. (2018). *Magnitude of Muscle Strength and Mass Adaptations Between High-Load Resistance Training Versus Low-Load Resistance Training Associated with Blood-Flow Restriction: A Systematic Review and Meta-Analysis.* Sports Medicine, 48(2), 361–378. DOI: [10.1007/s40279-017-0795-y](https://doi.org/10.1007/s40279-017-0795-y). PMID: 29043659.
